...
import ru.mirea.survillo.mireaproject.databinding.FragmentRecordAudioBinding;
import ru.mirea.survillo.mireaproject.ui.RecorderService;
...
public class RecordAudioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startRecordButton = binding.btnStart;
        stopRecordButton = binding.btnStop;
        binding.btnStart.setOnClickListener(this::onRecordStart);
        binding.btnStop.setOnClickListener(this::onStopRecord);
        binding.listenBtn.setOnClickListener(this::onListenRecord);
